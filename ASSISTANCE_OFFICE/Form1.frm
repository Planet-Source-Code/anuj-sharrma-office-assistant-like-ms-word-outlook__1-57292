...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton cmdPlayOneByOne 
      Caption         =   "play one by one"
      Height          =   525
      Left            =   6450
      TabIndex        =   20
      Top             =   3690
...
Private Sub cmdPlayOneByOne_Click()
Character.Play ListView1.ListItems.Item(16)
End Sub
...
Case 0 '-- The Play button was clicked, play an animation
    ...
    Character.Play ListView1.SelectedItem.Text
...
MyAgent.Characters.Load "CharacterID", ABBC
OpenSuccess = True
...
For Each AnimationName In Character.AnimationNames
'    Set lvwitem = ListView1.ListItems.Add(AnimationName)
    ListView1.ListItems.Add , , AnimationName
Next
Dim iCount As Integer
iCount = AnimationListBox.ListCount
For iCount = 0 To AnimationListBox.ListCount
Debug.Print AnimationListBox.List(5)
...
ErrHandler:
    ...
    End If
Me.Hide
'Character.Play AnimationListBox.List(9)
End Sub
